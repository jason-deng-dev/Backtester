...
The responsibility is up to the Derived classes of Signal/Sizer/RiskManager to deal with the case that they don't have enough history to produce an output
